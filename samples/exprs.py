exprs = [
    ...
    r"M _ { 1 } \approx \frac { m _ { 1 D } ^ { 2 } } { m _ { 2 } } \frac { 1 } { \sin ^ { 2 } \theta _ { 1 2 } ^ { \nu } } , ~ ~ ~ M _ { 2 } \approx \allowbreak 2 \frac { m _ { 2 D } ^ { 2 } } { m _ { 3 } } , ~ ~ ~ M _ { 3 } \approx \frac { 1 } { 2 } \frac { m _ { 3 D } ^ { 2 } } { m _ { 1 } } \sin ^ { 2 } \theta _ { 1 2 } ^ { \nu } ;",
    r"j ( x ) = \frac { 1 } { 2 } g _ { 1 } ( x ) + \allowbreak \frac { 1 } { 2 } \int _ { x } ^ { 1 } \left( 3 + 2 \ln \frac { y } { x } \right) \frac { g _ { 1 } ( y ) } { y } d y ,",
    r"s _ { L } ( x ) = \frac { 1 } { 2 } g _ { 1 } ( x ) + \int _ { x } ^ { 1 } \left( \ln \frac { y } { x } - \allowbreak \frac { 1 } { 2 } \right) \frac { g _ { 1 } ( y ) } { y } d y ,",
]
